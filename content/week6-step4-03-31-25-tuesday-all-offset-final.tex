...
\lecturechapter{Dienstag}{31. Mär}{31. März 2025}{Grundstrukturen und das Auswahlaxiom}
...
\subsection{Äquivalenzen zum Auswahlaxiom über ZF}
...
Und dann gibt es noch das Dritte, was äquivalent über $\text{ZF}$ ist, nämlich das Kuratowski-Zorn-Lemma. Das sagt etwas über eine Halbordnung aus. Es ist jetzt nicht so wichtig, was genau es besagt, aber aus diesem Kuratowski-Zorn-Lemma kriegen Sie dann eben zum Beispiel, dass jeder Vektorraum eine Basis hat. Und das ist dann etwas, was Sie in der Realität brauchen werden.
\end{spoken-clean}
...
\subsection{Formale Formulierung des Auswahlaxioms}
...
\[
X_0 \times X_1 \ni \langle x_0, x_1 \rangle \in \begin{pmatrix} 0 \mapsto x_0 \\ 1 \mapsto x_1 \end{pmatrix} \in \bigtimes_{i \in I=\{0,1\}} X_i
\]
\end{math-stroke}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \item Jede nichtleere Teilmenge von $\alpha$ besitzt ein minimales Element.
\end{enumerate}
\end{definition}
\end{math-stroke}

\subsection{Eigenschaften der Ordinalzahlklasse}
...
\begin{enumerate}[label=\textbf{(\arabic*)}]
    ...
    \item $\forall \alpha \in \beta, \beta \in \Omega \implies \alpha \in \Omega$
...
\subsection{Beweis: Auswahlaxiom impliziert Wohlordnungsprinzip}
...
\subsection{Aussage und Äquivalenz}
