...
\lecturechapter{Dienstag}{14. Apr}{14. April 2025}{Auswahlaxiom und Ordinalzahlen}
...
Folgende Definition ist zur Defintition \cref{def:ordinalzahl} äquivalent: Eine Menge $\alpha$ ist eine \newterm{Ordinalzahl}, falls $\alpha$ transitiv ist und durch die Relation $\in$ wohlgeordnet ist.
\end{definition}
\end{math-stroke}
