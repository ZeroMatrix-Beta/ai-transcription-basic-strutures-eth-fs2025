...
\lecturechapter{Dienstag}{19. Mai}{19. Mai 2025}{Äquivalenzrelationen und Kryptographie}
...
Die Relation $\equiv \pmod n$ ist eine Äquivalenzrelation auf $\mathbb{Z}$. Dies bedeutet:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Rückrichtung ($\Leftarrow$):} Sei $\operatorname{ggT}(a, n) = 1$. Nach dem Lemma von Bézout existieren $b, \ell \in \mathbb{Z}$ mit $a \cdot b + n \cdot \ell = 1$. Dies impliziert $a \cdot b = 1 - n \cdot \ell$, also $a \cdot b \equiv 1 \pmod n$. Somit gilt $[a] \cdot [b] = [1]$ in $\mathbb{Z}_n$.
\end{itemize}
\end{short-proof}
\end{math-stroke}
