...
\lecturechapter{Tuesday}{Apr 14th}{April 14th 2025}{Auswahlaxiom und Ordinalzahlen}
...
\begin{math-stroke}[Definition der Ordinalzahl]
...
\begin{proof}[$\text{WOP} \implies \text{KZL}$]
...
Sei $f: \bigcup_{\beta \in \lambda} {}^{\beta}P \to P$.
Für $t: \beta \to P$ definiere:
\[
f(t) = \begin{cases}
\emptyset & \text{falls } \beta = 0 \\
...
\begin{proof}[$\text{KZL} \implies \text{TP}$]
...
\begin{proof}[$\text{TP} \implies \text{AC}$]
