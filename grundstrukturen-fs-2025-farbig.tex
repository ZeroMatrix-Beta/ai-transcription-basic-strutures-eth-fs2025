...
\titlecontents{subsection}[4.0em]
  ...
  {\color{ThemeSecondary!90!black}\thecontentslabel\hspace{0.8em}\color{TextBoldColor}}
  {}
  {\color{HeaderFooterLine}\titlerule*[0.6pc]{.}\color{TextBoldColor}\contentspage}

\titlecontents{subsubsection}[6.5em]
  {\addvspace{1.5pt}\sffamily\small\bfseries\color{DeepSeaGreenBright2}}
  {\color{SubSubSecNumberColor}\thecontentslabel\hspace{0.8em}\color{DeepSeaGreenBright2}}
  {}
  {\normalfont\color{HeaderFooterLine}\titlerule*[0.6pc]{.}\color{DeepSeaGreenBright2}\contentspage}
...
\crefalias{axioms}{axioms}
\crefalias{property}{property}
...
\begin{minipage}{\textwidth}
    {\sffamily\fontsize{40pt}{48pt}\selectfont\bfseries\color{ThemePrimary!95!black} Grundstrukturen \par}
    \vspace{1.2cm}
    {\color{ThemeWeekNumber}\rule{\linewidth}{2.5pt}\par}
    \vspace{0.2cm}
    {\color{ThemeAccent1}\rule{0.6\linewidth}{1.5pt}\par}
    \vspace{2.0cm}
    {\sffamily\fontsize{18pt}{24pt}\selectfont\bfseries\color{TextEmphColor} Vorlesungsskript \par}
    \vspace{0.6cm}
    {\sffamily\fontsize{15pt}{22pt}\selectfont\color{TextBoldColor} Dozent: \textbf{Christian Urech} \par}
    \vspace{0.3cm}
    {\sffamily\fontsize{14pt}{20pt}\selectfont\color{DarkSlateGray} Departement Mathematik -- ETH Zürich \par}
    \vspace{2.5cm}
    {\sffamily\fontsize{14pt}{20pt}\selectfont\bfseries\color{ThemeWeekNumber}\faGraduationCap\quad Frühlingssemester 2026 \par}
\end{minipage}
\vfill
\begin{minipage}{\textwidth}
    {\sffamily\small\color{HeaderFooterFaint} LLM-gestützte Mitschrift der Vorlesung an der ETH Zürich $\cdot$ FS 2026}
\end{minipage}
\vspace*{1.5cm}
\end{titlepage}
...
\include{content/week1-step4-02-17-25-tuesday-all-offset-final.tex}

\include{content/week2-step5-02-24-25-tuesday-all-offset-last_try.tex}

\include{content/week3-step4-03-03-25-tuesday-all-offset-final.tex}

\include{content/week4-step5-03-10-25-tuesday-all-offset-last_try.tex}

\include{content/week5-step5-03-24-25-tuesday-all-offset-last_try.tex}

\include{content/week6-step4-03-31-25-tuesday-all-offset-final.tex}

\include{content/week8-step5-04-14-25-tuesday-all-offset-last_try.tex}

\include{content/week9-step4-04-21-25-tuesday-all-offset-final.tex}

\include{content/week10-step4-04-28-25-tuesday-all-offset-final.tex}

\include{content/week11-step4-05-05-25-tuesday-all-offset-final.tex}

\include{content/week12-step4-05-12-25-tuesday-all-offset-final.tex}

\include{content/week13-step4-05-19-25-tuesday-all-offset-final.tex}

\include{content/week14-step4-05-26-25-tuesday-all-offset-final.tex}
