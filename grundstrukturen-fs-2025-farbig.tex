...
\colorlet{HeaderFooterFaint}{ThemePrimary!45!Gray}
\colorlet{HeaderFooterLine}{HeaderFooterFaint!50}
\colorlet{ChapTitleText}{ThemeSecondary!90!black}
\colorlet{ChapNumberText}{ThemePrimary!80!black}
...
\NewDocumentCommand{\lecturechapter}{ o m m m m }{%
  ...
  \chapter[#2, #4: #5]{{\Large\color{ThemePrimary}#2: #4} \texorpdfstring{\\[1ex]}{-- } {\LARGE #5}}%
  ...
  \fi
  \markboth{\chaptername\ \thechapter\ \ ---\ \ #4\ \ ---\ \ #5}{}%
}
...
\include{content/week7-step5-04-14-25-tuesday-all-offset-last_try.tex}

\include{content/week8-step4-04-21-25-tuesday-all-offset-final.tex}

\include{content/week9-step4-05-05-25-tuesday-all-offset-final.tex}
