...
\fancyhead[R]{\parbox[b]{0.18\textwidth}{\sloppy\raggedleft\small\sffamily\bfseries\color{HeaderFooterFaint}\thepage}}
...
\newcommand{\lecturechapter}[4]{%
  \chapter[#1, #3: #4]{{\Large\color{ThemePrimary}#1: #3} \texorpdfstring{\\[1ex]}{-- } {\LARGE #4}}%
